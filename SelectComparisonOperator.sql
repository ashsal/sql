...
select * from products_5 where price = 79.99;

select * from products_5 where manufacturer = 'Apple';
...
select * from products_5 where price > 349.99;

select product_id, product_name from products_5 where price > 349.99;
