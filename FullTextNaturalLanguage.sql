...
select * from articles_full where match(content) against('database management' in natural language mode);


select * from articles_full where match(content) against('database management');


select * from articles_full where match(content) against('performance enabling' in natural language mode);


select * from articles_full where match(content) against('performance enabling');
...
select * from articles_full where content like '%performance%' and content like '%enabling%'